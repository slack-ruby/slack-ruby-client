...
* [#261](https://github.com/slack-ruby/slack-ruby-client/pull/261): Handle `Errno::EPIPE` in `Slack::RealTime::Concurrency::Async` ping worker - [@dblock](https://github.com/dblock).
