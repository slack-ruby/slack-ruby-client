    ...
    class App
      ...
      command 'assistant_threads' do |g|
        ...
        g.command 'setStatus' do |c|
          ...
          c.flag 'is_send_allowed', desc: 'Whether or not the user is allowed to send a message while the status is being displayed.'
        ...
        g.command 'setSuggestedPrompts' do |c|
          ...
          c.flag 'title', desc: 'Title for the prompts. For example: Suggested Prompts, Related questions.'
          c.action do |_global_options, options, _args|
