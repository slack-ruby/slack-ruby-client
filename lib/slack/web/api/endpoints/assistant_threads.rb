    ...
    module Api
      module Endpoints
        module AssistantThreads
          ...
          # @option options [boolean] :is_send_allowed
          #   Whether or not the user is allowed to send a message while the status is being displayed.
          ...
          #   Title for the prompts. For example: Suggested Prompts, Related questions.
