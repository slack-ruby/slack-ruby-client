...
RSpec.describe Slack::Web::Api::Endpoints::AdminRoles do
  ...
  context 'admin.roles_addAssignments' do
    ...
    it 'requires user_ids' do
      expect { client.admin_roles_addAssignments(role_id: %q[R0001], entity_ids: %q[['T00000001', 'E00000002']]) }.to raise_error ArgumentError, /Required arguments :user_ids missing/
    end
  end
  context 'admin.roles_removeAssignments' do
    ...
    it 'requires user_ids' do
      expect { client.admin_roles_removeAssignments(role_id: %q[R0001], entity_ids: %q[['T00000001', 'E00000002']]) }.to raise_error ArgumentError, /Required arguments :user_ids missing/
    end
  end
end
