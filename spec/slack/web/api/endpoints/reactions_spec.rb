...
RSpec.describe Slack::Web::Api::Endpoints::Reactions do
  ...
  context 'reactions_add' do
    it 'requires channel' do
      expect { client.reactions_add(name: %q[thumbsup], timestamp: %q[]) }.to raise_error ArgumentError, /Required arguments :channel missing/
    end
    it 'requires name' do
    ...
    it 'requires timestamp' do
      expect { client.reactions_add(channel: %q[], name: %q[thumbsup]) }.to raise_error ArgumentError, /Required arguments :timestamp missing/
    end
  end
