...
RSpec.describe Slack::Web::Api::Endpoints::AdminConversationsRestrictaccess do
  ...
  context 'admin.conversations.restrictAccess_removeGroup' do
    it 'requires team_id' do
      expect { client.admin_conversations_restrictAccess_removeGroup(group_id: %q[], channel_id: %q[]) }.to raise_error ArgumentError, /Required arguments :team_id missing/
    end
    it 'requires group_id' do
      expect { client.admin_conversations_restrictAccess_removeGroup(team_id: %q[], channel_id: %q[]) }.to raise_error ArgumentError, /Required arguments :group_id missing/
    end
    it 'requires channel_id' do
      expect { client.admin_conversations_restrictAccess_removeGroup(team_id: %q[], group_id: %q[]) }.to raise_error ArgumentError, /Required arguments :channel_id missing/
    end
  end
end
