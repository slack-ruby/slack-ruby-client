...
RSpec.describe Slack::Web::Api::Endpoints::Chat do
  ...
  context 'chat_appendStream' do
    it 'requires channel' do
      expect { client.chat_appendStream(ts: %q[]) }.to raise_error ArgumentError, /Required arguments :channel missing/
    end
    it 'requires ts' do
      expect { client.chat_appendStream(channel: %q[]) }.to raise_error ArgumentError, /Required arguments :ts missing/
    end
  end
  ...
  context 'chat_startStream' do
    it 'requires channel' do
      expect { client.chat_startStream }.to raise_error ArgumentError, /Required arguments :channel missing/
    end
  end
  ...
  context 'chat_unfurl' do
    it 'encodes unfurls, user_auth_blocks as json' do
      expect(client).to receive(:post).with('chat.unfurl', {unfurls: %q[{"data":["data"]}], user_auth_blocks: %q[{"data":["data"]}]})
      client.chat_unfurl(unfurls: {data: ["data"]}, user_auth_blocks: {data: ["data"]})
    end
  end
  context 'chat_update' do
    ...
    it 'encodes attachments, unfurled_attachments, blocks, metadata as json' do
      ...
      client.chat_update(attachments: {data: ["data"]}, channel: %q[], text: %q[Hello world], ts: %q["1405894322.002768"], unfurled_attachments: {data: ["data"]}, blocks: {data: ["data"]}, metadata: {data: ["data"]})
    end
  end
end
