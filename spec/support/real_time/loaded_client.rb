...
RSpec.shared_context 'loaded client' do
  before do
    ...
    client.channels['C0HNTD0CW'] = Slack::RealTime::Models::Channel.new(
      id: 'C0HNTD0CW',
      name: 'chess',
      is_channel: true,
      is_group: false,
    ...
    client.channels['C0HLE0BBL'] = Slack::RealTime::Models::Channel.new(
      id: 'C0HLE0BBL',
      name: 'gifs',
      is_channel: true,
      is_group: false,
    ...
    client.channels['C0JHNAB5H'] = Slack::RealTime::Models::Channel.new(
      id: 'C0JHNAB5H',
      name: 'rubybot-test',
      is_channel: true,
    ...
    client.groups['G0K7EV5A7'] = Slack::RealTime::Models::Group.new(
      id: 'G0K7EV5A7',
